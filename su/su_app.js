...
window.suDbAddRow = function() {
    ...
    mainRow.innerHTML =
        ...
        +       '<input type="number" class="db-peso-real" value="0" min="0" step="1" placeholder="—" autocomplete="off" onchange="suDbOnChangeSustratoReal(this)">'
        +     '</div>'
        ...
        +       '<input type="number" class="db-peso-bolsa-inoculada" value="0" min="0" step="0.1" placeholder="—" autocomplete="off" onchange="suDbOnChangeBolsaInoculada(this)">'
        ...
        +       '<input type="number" class="db-peso-grano-real" value="0" min="0" step="0.1" placeholder="—" autocomplete="off">'
        +     '</div>'
        +   '</div>'
        + '</div>'
